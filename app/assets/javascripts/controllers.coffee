define ["app"], (module)->
	...
	module.controller "GroupListCtrl" , ["$scope",GroupListCtrl]

	EventListCtrl = ($scope, $routeParams) ->
	...
	module.controller "EventListCtrl" , ["$scope" , "$routeParams" , EventListCtrl]
	...
	module.controller "EventCtrl" , ["$scope","$routeParams","Event", EventCtrl]
